...
int main()
{
    ...
    for (int i = 1; i <= N; i++)
    {
        ...
        win[i].x1 += 4000; win[i].y1 += 4000;win[i].y2 += 4000; win[i].x2 += 4000;
         win[i].y1 = 8000 - win[i].y1;win[i].y2 = 8000-win[i].y2;
    ...
    for (int i = 1; i <= N; i++)
    {
        dif[rx[win[i].x1]][ry[win[i].y1]] += 1;
        dif[rx[win[i].x2]][ry[win[i].y2]] += 1;
        dif[rx[win[i].x1]][ry[win[i].y2]] -= 1;
        dif[rx[win[i].x2]][ry[win[i].y1]] -= 1;
    }
